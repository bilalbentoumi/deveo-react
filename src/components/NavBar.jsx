        ...
        <div className="bg-white bg-opacity-90 backdrop-blur-2xl border-b fixed left-0 right-0 h-16 flex items-center border-b border-gray-900/10 dark:border-gray-50/[0.06] z-10">
            ...
            <div className="deveo-container mx-auto w-full grid grid-cols-12 gap-4 items-center">
                        ...
                        <svg width="26" height="26" viewBox="0 0 233 233" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                                <linearGradient id="paint0_linear_9_12" x1="116.5" y1="0" x2="116.5" y2="233" gradientUnits="userSpaceOnUse">
                                    <stop stopColor="#182A4B"/>
                                    <stop offset="1" stopColor="#12122B"/>
                                </linearGradient>
                            </defs>
                        </svg>
                ...
                <div className="col-span-7 md:col-span-5 lg:col-span-5 xl:col-span-7 hidden md:block">
                    <div className="search flex flex-grow relative text-sm leading-6 text-gray-400 shadow-sm rounded-md overflow-hidden bg-white ring-1 ring-gray-900/10 hover:ring-gray-300 dark:bg-gray-800 dark:highlight-white/5 dark:hover:bg-gray-700">
                        <svg width="24" height="24" fill="none" aria-hidden="true" className="absolute top-1.5 left-2.5 text-gray-400">
                            <path d="m19 19-3.5-3.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            <circle cx="11" cy="11" r="6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        <input className="p-1.5 w-full pl-10 pr-14 bg-transparent" type="text" placeholder="Search..."/>
                        <span className="flex-none text-xs font-semibold absolute right-3 top-2.5 text-gray-400 pointer-events-none">Ctrl K</span>
                    </div>
                </div>

                <div className="col-span-8 md:col-span-4 lg:col-span-4 xl:col-span-3">
                    <div className="buttons flex items-center gap-2 justify-end">
